...
public class Product_A {
    ...
    private String ProductID;    //var for the ID number of the product
    ...
    Product_A(String ProductName, float ProductPrice, int ProductQuantity, String ProductID, String ProductBrand){
    ...
    public float Inventory_Value(float ProdPrice, float ProdQuantity){
        return ProdPrice*ProdQuantity ;
}
}   